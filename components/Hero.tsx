		...
		<section className='max-container padding-container flex flex-col gap-20 py-10 pt-[80px] pb-32 md:gap-[68px] lg:py-20 xl:flex-row'>
			...
			<div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
				...
				<div className='my-11 flex flex-wrap gap-5'>
					...
					<p className='bold-16 lg:bold-18 text-blue-600'>
						198k
						<span> Exellent Reviews</span>
					</p>
				</div>
			...
			<div className='relative flex flex-1 items-start'>
				<div className='relative z-20 flex w-[268px] flex-col gap-8 rounded-3xl bg-green-90 py-8 px-8'>
					<div className='flex flex-col'>
						...
						<p className='bold-20 text-white'>Eleyele</p>
					</div>

					<div className='flexBetween'>
						<div className='flex flex-col'>
							<p className='regular-16 block text-gray-20'>Distance</p>
							<p className='bold-20 text-white'>262.17 mi</p>
						</div>
						<div className='flex flex-col'>
							<p className='regular-16 block text-gray-20'>Elevation</p>
							<p className='bold-20 text-white'>4.194 km</p>
						</div>
					</div>
				</div>
			</div>
